<?php
// filter_results.php
// This file contains just the schools list content for AJAX requests when applying filters
?>
...
<?php else: ?>
    <div class="no-results">
        <h2>No schools found matching your filter criteria.</h2>
        <p>Try adjusting your filters or <a href="javascript:void(0);" onclick="clearAllFilters()">clear all filters</a>.</p>
    </div>
<?php endif; ?>