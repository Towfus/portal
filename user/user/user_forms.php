...
<style>
    /* Use the same color variables as user_header.php */
    :root {
        ...
        /* Additional colors for forms page */
        --success-color: #27ae60;
        --info-color: #3498db;
        --border-color: #dee2e6;
    }

    /* Remove conflicting body styles and navbar overrides */
    /* The header styles from user_header.php will be used instead */
...
</div> <!-- Close main-content div from user_header.php -->
</div> <!-- Close body div from user_header.php -->
